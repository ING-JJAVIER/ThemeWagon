...
export default function Contact() {
  return (
    <main id='blog' className='w-full h-screen md:h-screen sm:h-screen '>
      ...
      <section>
        <article className='flex justify-center'>
          <form action="" className='border w-[22rem] p-4 rounded-3xl'>
            <label htmlFor="name" className='flex items-center gap-2 h-8 rounded-full px-3 border w-80'>
            ...
            <label htmlFor="email" className='my-4 flex items-center gap-2 h-8 rounded-full px-3 border w-80'>
              <figure className='text-gray-400'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-3">
            ...
            <label htmlFor="message" className='flex items-start gap-2 h-32 rounded-xl px-3 border w-80'>
